...
<body>
	<div class="container">
	    <h2 class="text-center m-4 text-primary">Novo Compromisso</h2>
		<form action="CompromissoServlet" method="post">
			...
			<input class="form-control" type="text" placeholder="Ex: Sala 301, Escritório Central" name="local" required="required">
			
			<label class="form-label mt-2">Contato Envolvido</label>
			<input class="form-control" type="text" placeholder="Ex: Carlos (Nome do Contato)" name="contato" required="required">
			...
			<button class="btn btn-success mt-3 w-100">Salvar Compromisso</button>
		</form>
