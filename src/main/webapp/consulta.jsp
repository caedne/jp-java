...
<body>
	<div class="container">
			...
			<tbody>
				...
				if (contatos != null) {
					for (Contato ct : contatos) {
						...
						out.print("<tr>" + "<td>" + ct.getNome() + "</td>" + // Célula 1: Nome
						"<td>" + ct.getTelefone() + "</td>" + // Célula 2: Telefone
						"<td>" + ct.getEmail() + "</td>" + // Célula 3: Email
						"<td>" + ct.getEmpresa() + "</td>" + // Célula 4: Empresa

						"<td><a href='ContatoServlet?acao=editar&id=" + ct.getId()
						+ "' class='btn btn-sm btn-info'>Editar</a></td>" +

						"<td><a href='ContatoServlet?acao=excluir&id=" + ct.getId()
						+ "' class='btn btn-sm btn-danger' onclick='return confirm(\"Deseja excluir o contato: " + ct.getNome()
						+ "?\");'>Excluir</a></td>" + "</tr>");
					}
				} else {
		...
		<p class="text-end">
			<a href="cadastro.jsp" class="btn btn-primary">Novo Contato</a>
		</p>
