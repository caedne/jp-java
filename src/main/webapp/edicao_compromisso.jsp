<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="modelos.Compromisso, java.util.List, modelos.Contato"%>
<%
	
	Compromisso cpComErro = (Compromisso) request.getAttribute("compromissoComErro");
	
	
	Compromisso cp = (cpComErro != null) ? cpComErro : (Compromisso) request.getAttribute("compromisso");
		...
		<div class="row justify-content-center">
			<div class="col-lg-8">
						...
						<form action="CompromissoServlet?acao=alterar" method="post" >
							...
							<div class="mb-3">
								...
								<textarea class="form-control" name="descricao" rows="3" 
										  ...
										  required="required"><%out.print(cp.getDescricao());%></textarea>
							</div>
				...
				<div class="text-center mt-3">
					<a href="CompromissoServlet" class="btn btn-secondary">Voltar para a Lista</a>
				</div>
			</div>
		</div>
	</div>
